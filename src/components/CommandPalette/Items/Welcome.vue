  ...
  <div class="space-y-2">
    ...
    <CommandPaletteControls class="space-y-4">
      <Card :truncate="false" tight>
        Bienvenue sur la palette de commande, un outil pour vous aider ! Tu peux
        utiliser cette fenêtre partout sur le site ! N'oublie pas la combinaison
        de touches !
      </Card>
      ...
      <div class="grid grid-cols-2 overflow-x-auto">
        ...
        <Card :truncate="false" tight>
          Certains de mes comptes de médias sociaux
        </Card>
      </div>

      <Card tight>
        Cliquez sur l'un des articles à gauche pour commencer !
      </Card>

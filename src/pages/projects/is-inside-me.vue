  ...
  head() {
    ...
    return {
      ...
      link: [
        {
          rel: "canonical",
          href: "https://detygon.com/projects/is-inside-me",
        },
      ],
    }
  },
...
<template>
  <div class="space-y-6 py-6">
    <div class="space-y-8 text-gray-500 sm:w-9/12 dark:text-neutral-600">
      ...
      <div class="flex flex-wrap space-x-4 px-4">
        <SmartImage
      ...
      <div class="space-y-2 items-center sm:flex sm:space-x-2 sm:space-y-0">

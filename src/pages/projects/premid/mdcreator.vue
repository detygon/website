  ...
  <div class="pt-6">
    <div class="space-y-8">
      ...
      <div class="space-y-12 mt-2">
        ...
        <div class="space-y-8">
          ...
          <div
            class="flex-wrap space-y-2 mt-4 items-center sm:flex sm:space-y-0 sm:space-x-4"
          >
    ...
    <transition name="slide-left" mode="out-in">
      <div
        ...
        class="min-h-full bg-gray-100 top-0 right-0 bottom-0 fixed overflow-y-auto scrollbar sm:ml-auto sm:shadow-md sm:w-8/12 dark:bg-neutral-800"
      >
...
.control-button {
  ...
  &:not(.no-background) {
    @apply bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 hover:bg-gray-200;
  }
...
.input {
  ...
  &:not(.ring-0) {
    @apply ring-offset-gray-100 ring-gray-200 ring-offset-2 dark:ring-neutral-800 dark:ring-offset-neutral-900 focus:ring-1;
  }
}
...
.ring {
  @apply ring-1 ring-offset-2 ring-offset-gray-100 ring-gray-200 dark:ring-neutral-800 dark:ring-offset-neutral-900;
}
</style>

  ...
  <div class="pt-6">
    <div v-if="getFilteredPosts === false">
      ...
      <div class="space-y-6 mt-20">
        ...
        <div
          class="flex flex-col space-y-4 max-h-50vh overflow-y-auto md:overflow-y-visible md:grid md:grid-cols-2 md:max-h-full md:gap-4 md:space-y-0"
        >
          <CardPost
      ...
      <div class="mt-16">
        ...
        <div class="flex flex-wrap space-x-2 mt-4 items-center justify-center">
          <div
            ...
            :key="`pagination-${page}`"
            class="rounded-full cursor-pointer flex font-medium bg-gray-200 h-10 transition-colors ring-1 ring-gray-300 text-gray-900 w-10 items-center justify-center select-none dark:bg-neutral-800 dark:ring-neutral-800 dark:text-gray-100 dark:hover:bg-neutral-700 hover:bg-gray-300"
            :class="{
